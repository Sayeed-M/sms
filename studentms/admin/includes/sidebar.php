...
{               ?>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="add-class.php">Add Department</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage-class.php">Manage Department</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic1">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="view-student.php">view Students</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" href="add-recordings.php">
                <span class="menu-title">Recordings Curriculum</span>
                <!-- <i class="icon-magnifier menu-icon"></i> -->
              </a>
            </li>
            </li>
